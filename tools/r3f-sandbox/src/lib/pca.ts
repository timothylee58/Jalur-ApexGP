 ...
 * skipping any object whose name starts with `skipPrefix` — this app
 * uses it to exclude the procedurally-scattered palm trees, which would
 * otherwise skew the footprint's orientation/spread away from the actual
 * track+buildings layout the real apex centreline should register against.
 */
